...
@if(Auth::user()->hasRole('admin') || Auth::user()->hasRole('consultant'))
                    <a id="pdftravel" class="btn btn-primary" style="text-align:center;color:white; margin-bottom:20px;">Generate Pdf</a>
                    @endif
    <div class="form-card">
        ...
        <table>
            ...
            <tr>
                <td> Country </td>
                <td>
                    <select id="travelhistory_country5" name="travelhistory_country5" class="form-control">
                        <option value="">Select Country</option>
                        @if(!empty(isset($data->travelhistory_country5)))
                        <option value="{{$data->travelhistory_country5}}" selected>{{$data->travelhistory_country5}}</option>
                        @endif
            ...
            <tr>
                <td> Date From </td>
                <td> <input type="date" name="travelhistory_datefrom5" id="travelhistory_from5" @if(isset($data->travelhistory_datefrom5)) value="{{$data->travelhistory_datefrom5}}" @endif/> </td>
            </tr>

            <tr>
                <td> Date to </td>
                <td> <input type="date" name="travelhistory_dateto5" id="travelhistory_dateto5" @if(isset($data->travelhistory_dateto5)) value="{{$data->travelhistory_dateto5}}" @endif/> </td>
            </tr>

            <tr>
                <td>Purpose of your travel
                </td>
                <td> <input type="text" name="travelhistory_purpose5" id="travelhistory_purpose5" @if(isset($data->travelhistory_purpose5)) value="{{$data->travelhistory_purpose5}}" @endif/> </td>
            </tr>
                </tbody>
        </table>
