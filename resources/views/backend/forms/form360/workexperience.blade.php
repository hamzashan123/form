        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td> <input type="text" name="workexp3_your_position" id="workexp3_your_position" @if(isset($data->workexp3_your_position)) value="{{$data->workexp3_your_position}}" @endif/> </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="workexp3_your_position_type" id="workexp3_your_position_type" class="form-control">
                            <option value=""> Select Option </option>
                            @if(!empty(isset($data->workexp3_your_position_type)))
                            <option value="{{$data->workexp3_your_position_type}}" selected>{{$data->workexp3_your_position_type}}</option>
                            @endif
                            <option value="Full Time"> Full Time </option>
                            <option value="Part Time"> Part Time </option>
                            <option value="Other"> Other </option>
                ...
                <tr>
                    ...
                    <td> <input type="text" name="workexp3_employer_name" id="workexp3_employer_name" @if(isset($data->workexp3_employer_name)) value="{{$data->workexp3_employer_name}}" @endif/> </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                    <select id="workexp3_business_country" name="workexp3_business_country" class="form-control">
                            <option value="">Select Country</option>
                            @if(!empty(isset($data->workexp3_business_country)))
                            <option value="{{$data->workexp3_business_country}}" selected>{{$data->workexp3_business_country}}</option>
                            @endif
                            <option value="Afghanistan">Afghanistan</option>
                            <option value="Åland Islands">Aland Islands</option>
                            <option value="Albania">Albania</option>
                ...
                <tr>
                    ...
                    <td> <input type="date" name="workexp3_date_work_started" id="workexp3_date_work_started" @if(isset($data->workexp3_date_work_started)) value="{{$data->workexp3_date_work_started}}" @endif/> </td>
                </tr>
                ...
                <tr>
                    ...
                    <td> <input type="date" name="workexp3_date_work_ended" id="workexp3_date_work_ended" @if(isset($data->workexp3_date_work_ended)) value="{{$data->workexp3_date_work_ended}}" @endif/> </td>
                </tr>
                ...
                <tr>
                    ...
                    <td> <input type="text" name="workexp3_description_duties" id="workexp3_description_duties" @if(isset($data->workexp3_description_duties)) value="{{$data->workexp3_description_duties}}" @endif/> </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                    <select name="workexp3_nominated_position" id="workexp3_nominated_position" class="form-control">
                            <option value=""> Select Option </option>

                            @if(!empty(isset($data->workexp3_nominated_position)))
                            <option value="{{$data->workexp3_nominated_position}}" selected>{{$data->workexp3_nominated_position}}</option>
                            @endif
                            <option value="Yes"> Yes </option>
                            <option value="No"> No </option>
                        </select>    
                ...
                <tr>
                    ...
                    <td>
                        <select name="workexp3_performed_in_aus_nz" id="workexp3_performed_in_aus_nz" class="form-control">
                            <option value=""> Select Option </option>
                            @if(!empty(isset($data->workexp3_performed_in_aus_nz)))
                            <option value="{{$data->workexp3_performed_in_aus_nz}}" selected>{{$data->workexp3_performed_in_aus_nz}}</option>
                            @endif
                            <option value="Yes"> Yes </option>
                            <option value="No"> No </option>
                ...
                <tr>
                    ...
                    <td> <input type="text" name="workexp3_visa_employer" id="workexp3_visa_employer" @if(isset($data->workexp3_visa_employer)) value="{{$data->workexp3_visa_employer}}" @endif/> </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <select name="workexp3_payslips_for_this_week" id="workexp3_payslips_for_this_week" class="form-control">
                            <option value=""> Select Option </option>
                            @if(!empty(isset($data->workexp3_payslips_for_this_week)))
                            <option value="{{$data->workexp3_payslips_for_this_week}}" selected>{{$data->workexp3_payslips_for_this_week}}</option>
                            @endif
                            <option value="Payslip"> Payslip </option>
                            <option value="Invoice"> Invoice </option>
                            <option value="Other"> Other </option>
                ...
                <tr>
                    ...
                    <td>
                        <select name="workexp3_contact_details_work_period" id="workexp3_contact_details_work_period" class="form-control">
                            <option value=""> Select Option </option>
                            @if(!empty(isset($data->workexp3_contact_details_work_period)))
                            <option value="{{$data->workexp3_contact_details_work_period}}" selected>{{$data->workexp3_contact_details_work_period}}</option>
                            @endif
                            <option value="Yes"> Yes </option>
                            <option value="No"> No </option>
                ...
                <tr>
                    ...
                    <td> <input type="text" name="workexp3_contact_details_work_period_indicate" id="workexp3_contact_details_work_period_indicate" @if(isset($data->workexp3_contact_details_work_period_indicate)) value="{{$data->workexp3_contact_details_work_period_indicate}}" @endif/> </td>
                ...
                <tr>
                    ...
                    <td> <input type="text" name="workexp3_contact_details_work_period_name" id="workexp3_contact_details_work_period_name" @if(isset($data->workexp3_contact_details_work_period_name)) value="{{$data->workexp3_contact_details_work_period_name}}" @endif/> </td>
                ...
                <tr>
                    ...
                    <td> <input type="text" name="workexp3_contact_details_work_period_position" id="workexp3_contact_details_work_period_position" @if(isset($data->workexp3_contact_details_work_period_position)) value="{{$data->workexp3_contact_details_work_period_position}}" @endif/> </td>
                ...
                <tr>
                    ...
                    <td> <input type="email" name="workexp3_contact_details_work_period_email" id="workexp3_contact_details_work_period_email" @if(isset($data->workexp3_contact_details_work_period_email)) value="{{$data->workexp3_contact_details_work_period_email}}" @endif/> </td>
                ...
                <tr>
                    ...
                    <td> <input type="tel" name="workexp3_contact_details_work_period_phone" id="workexp3_contact_details_work_period_phone" @if(isset($data->workexp3_contact_details_work_period_phone)) value="{{$data->workexp3_contact_details_work_period_phone}}" @endif/> </td>
