        ...
        <table>
            <tbody>
                ...
                <tr>
                    ...
                    <td> <input type="text" name="work_referee_phone" id="work_referee_phone" class="numberfixed" @if(isset($data['work'][0]->work_referee_phone)) value="{{$data['work'][0]->work_referee_phone}}" @endif />
                    </td>
                </tr>
