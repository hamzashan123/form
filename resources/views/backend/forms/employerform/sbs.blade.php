            ...
            <tbody>
                ...
                <tr>
                    <td>How many recent Australian university
                        ...
                        experience </td>
                    <td>
                    <select name="organization_foreign_recent_university" id="organization_foreign_recent_university" class="form-control">

<option value=""> Select Option </option>
@if(!empty(isset($data->organization_foreign_recent_university)))
<option value="{{$data->organization_foreign_recent_university}}" selected>{{$data->organization_foreign_recent_university}}</option>
@endif
<option value="0">0</option>
<option value="1">1</option>
<option value="2">2</option>
