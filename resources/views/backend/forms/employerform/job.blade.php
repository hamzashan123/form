        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td> <input type="text" name="job_n2_people" id="job_n2_people" />
                    </td>
                </tr>
                ...
                <tr>
                    <td> Number of people who were shortlisted for
                        the role </td>
                    <td> <input type="text" name="job_n2_people_shortlisted" id="job_n2_people_shortlisted" /> </td>
                </tr>
                ...
                <tr>
                    ...
                    <td> <input type="text" name="job_n2_people_suitable" id="job_n2_people_suitable" /> </td>
                </tr>
            </tbody>
        </table>
        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td> <input type="text" name="job_n3_people" id="job_n3_people" />
                    </td>
                </tr>

                <tr>
                    <td> Exact date when the job ad was put online </td>
                    <td> <input type="date" name="job_n3_exact_date" id="job_n3_exact_date" /> </td>
                </tr>
                ...
                <tr>
                    <td> Please confirm this job ad has been online
                        ...
                        it expires </td>
                    <td> <input type="text" name="job_n3_online" id="job_n3_online" /> </td>
                </tr>

                <tr>
                    <td> Please indicate the link to the job ad here
                    </td>
                    <td> <input type="text" name="job_n3_indicate" id="job_n3_indicate" /> </td>
                </tr>
                ...
                <tr>
                    ...
                    <td> <input type="text" name="job_n3_payment" id="job_n3_payment" /> </td>
                </tr>
        ...
        <table>
            <tbody>
                <tr>
                    <td> Number of people who applied for the
                        position to be filled </td>
                    <td> <input type="text" name="job_n3_after_people" id="job_n3_after_people" />
                    </td>
                </tr>
                ...
                <tr>
                    <td> Number of people who were shortlisted for
                        the role </td>
                    <td> <input type="text" name="job_n3_after_people_shortlisted" id="job_n3_after_people_shortlisted" /> </td>
                </tr>
                ...
                <tr>
                    <td> Reason why no one was suitable for the role
                        and therefore you are offering the full-time
                        position to the visa applicant </td>
                    <td> <input type="text" name="job_n3_after_people_suitable" id="job_n3_after_people_suitable" /> </td>
                </tr>
            </tbody>
        </table>
