<fieldset id="fieldsetfour">
    <div class="form-card">
        ...
        <div class="row">
            <div class="col-7">
                <h2 class="fs-title">After the 28 day period
                 </h2> 
            </div>
            <div class="col-5">
        ...
        <table>
            <tbody>
                <tr>
                    ...
                    <td> 
            <select name="job_n2_people" id="job_n2_people" class="form-control">

                    <option value=""> Select Option </option>
                @if(!empty(isset($data->job_n2_people)))
                <option value="{{$data->job_n2_people}}" selected>{{$data->job_n2_people}}</option>
                @endif
                ...
                <tr>
                    <td> Number of people who were shortlisted for
                        the role </td>
                    <td> 
                    <select name="job_n2_people_shortlisted" id="job_n2_people_shortlisted" class="form-control">

                                <option value=""> Select Option </option>
                                @if(!empty(isset($data->job_n2_people_shortlisted)))
                                <option value="{{$data->job_n2_people_shortlisted}}" selected>{{$data->job_n2_people_shortlisted}}</option>
                                @endif
                                <option value="0">0</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
            ...
            <tbody>
                <tr>
                    <td> Number of people who applied for the
                        position to be filled </td>
                    <td> 
            <select name="job_n4_people" id="job_n4_people" class="form-control">

                    <option value=""> Select Option </option>
                @if(!empty(isset($data->job_n4_people)))
                <option value="{{$data->job_n4_people}}" selected>{{$data->job_n4_people}}</option>
                @endif
                <option value="0">0</option>
                <option value="1">1</option>
                <option value="2">2</option>
                ...
                <tr>
                    <td> Number of people who were shortlisted for
                        the role </td>
                    <td> 
                    <select name="job_n4_people_shortlisted" id="job_n4_people_shortlisted" class="form-control">

                                <option value=""> Select Option </option>
                                @if(!empty(isset($data->job_n4_people_shortlisted)))
                                <option value="{{$data->job_n4_people_shortlisted}}" selected>{{$data->job_n4_people_shortlisted}}</option>
                                @endif
                                <option value="0">0</option>
                                <option value="1">1</option>
                                <option value="2">2</option>
            ...
            <tbody>
                <tr>
                    <td> Number of people who applied for the
                        position to be filled </td>
                    <td> 
                    <select name="job_n3_after_people" id="job_n3_after_people" class="form-control">

<option value=""> Select Option </option>
@if(!empty(isset($data->job_n3_after_people)))
<option value="{{$data->job_n3_after_people}}" selected>{{$data->job_n3_after_people}}</option>
@endif
<option value="0">0</option>
<option value="1">1</option>
<option value="2">2</option>
...
<option value="100">100</option>
                ...
                <tr>
                    <td> Number of people who were shortlisted for
                        the role </td>
                    <td> 
                    <select name="job_n3_after_people_shortlisted" id="job_n3_after_people_shortlisted" class="form-control">

<option value=""> Select Option </option>
@if(!empty(isset($data->job_n3_after_people_shortlisted)))
<option value="{{$data->job_n3_after_people_shortlisted}}" selected>{{$data->job_n3_after_people_shortlisted}}</option>
@endif
<option value="0">0</option>
<option value="1">1</option>
<option value="2">2</option>
